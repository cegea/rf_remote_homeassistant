...
//#define MQTT_HOST         "mqtt://homeassistant.local"        // Broker address
...
void setup_mqtt()
{ 
  mqttClient.setCredentials("homeassistant", "loodeenuh7quohng5aemieTheequ5EigohheeMah1no2shee8ef9eewog5ahngee");
  Serial.begin(115200);
